...
#endif
/*Cj_Lai , The VMG1312-B10X hw diff with VMG8x24-B10X. */
...
#if defined(CONFIG_BCM96816) || defined(CONFIG_BCM96368) || defined(CONFIG_BCM96328) || defined(CONFIG_BCM96362) || defined(CONFIG_BCM963268) || defined(CONFIG_BCM96318)
...
#if 0 //__MSTC__, DelonYu, merge patch from CSP#448131 for DSL-491HNU-B1Bv2 board
	//external phy4 (Ethernet WAN)
	x16 = 0x81f7;
	ethsw_phy_wreg(ETHSW_PHY_GET_PHYID(4), 0x18, &x16); // Enable Ethernet@wirespeed for Ether WAN port by default

#if 0 //__MSTC__, DelonYu, turn on if you have to support giga LAN4
	//internal phy3 (LAN4)
	x16 = 0x0200;
	ethsw_phy_wreg(ETHSW_PHY_GET_PHYID(3), 0x9, &x16); // Enable 1000M capability for LAN4 ports by default
	x16 = 0x8077;
	ethsw_phy_wreg(ETHSW_PHY_GET_PHYID(3), 0x18, &x16); // Enable Ethernet@wirespeed for LAN4 ports by default
#endif
#endif
#if 1 //__MSTC__, DelonYu, merge patch from CSP#448131 for DSL-491GNU-B1D C3 board
#if 1//__Telecom__,JhenYang, work around for LAN link rate sync error.
#else
...
#if 0 //__MSTC__, Dennis, merge patch from CSP#451064
    ethsw_disable_hw_switching(); //call this function
#endif
#if defined(CONFIG_BCM96816)
